...
class _ListDialogsPageState extends State<ListDialogsPage> {
  ...
  Future<void> initialisation() async {
    _listDialogs =
        await databaseManager.retrieveDialogsFromLanguage(langFR ? "fr" : "nl");
    setState(() {});
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: CustomTitle(
                                        ...
                                        textColor:
                                            const Color.fromRGBO(29, 52, 83, 1),
                                      ),
                                    ),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              AnimatedScale(
                                scale:
                                    _buttonAnimations["TOP ARROW"]! ? 1.1 : 1.0,
                                duration: const Duration(milliseconds: 100),
                                curve: Curves.bounceOut,
                                child: GestureDetector(
                                  // Animation management
                                    ...
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(
                                          MediaQuery.of(context).size.width *
                                              0.01),
                                      color:
                                          const Color.fromRGBO(101, 72, 254, 1),
                                    ),
                              ...
                              AnimatedScale(
                                scale:
                                    _buttonAnimations["BOT ARROW"]! ? 1.1 : 1.0,
                                duration: const Duration(milliseconds: 100),
                                curve: Curves.bounceOut,
                                child: GestureDetector(
                                  // Animation management
