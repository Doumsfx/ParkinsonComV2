...
import '../../models/database/sms.dart';

class ConversationPage extends StatefulWidget {
  final int idContact;
  const ConversationPage({super.key, required this.idContact});
...
class _ConversationPageState extends State<ConversationPage> {
  ...
  Future<void> initialisation() async {
    ...
    _listSMS = await databaseManager.retrieveSmsFromContact(widget.idContact);
    setState(() {});
  }
